    ...
    public Ejemplo1() {
        initComponents();
         ...
         try {
            ...
            modelo.addColumn("ID Film");
            modelo.addColumn("Nombre Film");
    
            
            int[] anchos = {50, 200, 50, 50};
            for (int i = 0; i < jtFilms.getColumnCount(); i++) {
                jtFilms.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
            }
